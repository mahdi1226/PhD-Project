...
// ============================================================================
#define TEST_ID "C"
#define TEST_H_FORMULA ": C: H = h_a + grad_phi (NS), grad_phi (Mag)"
// Options:
 ...
 */
inline std::string get_timestamp_compact_local()
{
 ...
 */
inline std::string get_timestamp_local()
{
 ...
 */
inline std::string get_timestamp_compact(MPI_Comm comm = MPI_COMM_WORLD)
{
 ...
 */
inline std::string get_timestamp(MPI_Comm comm = MPI_COMM_WORLD)
{
    std::string timestamp;
 ...
 */
inline std::string get_csv_header_stamp(const Parameters& params, MPI_Comm comm = MPI_COMM_WORLD)
{
    std::ostringstream ss;
    ss << "# ";
