...
// ============================================================================
// Print applied field diagnostic (console output, rank 0 only)
// ============================================================================
inline void diagnose_applied_field(const Parameters& params,
                                    double time,
                                    MPI_Comm comm = MPI_COMM_WORLD)
{
    ...
    // Print dipole positions (truncated for large arrays)
    std::cout << "\nDipole positions:\n";
    ...
    else if (h_center.norm() > 1.5 * h_edge.norm())
    {
...
// ============================================================================
// Write h_a field to CSV for visualization (rank 0 only)
// ============================================================================
inline void write_field_csv(const Parameters& params,
                            double time,
...
// ============================================================================
// Write full spatial field profile at a specific time
// ============================================================================
inline void write_field_profile(const Parameters& params,
                                double time,
                                unsigned int step,
