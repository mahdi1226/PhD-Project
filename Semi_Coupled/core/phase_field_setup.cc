...
void PhaseFieldProblem<dim>::setup_ch_system()
{
    ...
    setup_ch_coupled_system<dim>(
        ...
        ch_locally_owned_, ch_locally_relevant_,
        theta_to_ch_map_, psi_to_ch_map_,
        ch_constraints_, ch_matrix_,
...
void PhaseFieldProblem<dim>::initialize_solutions()
{
    ...
    public:
        ...
        CircularDropletIC(double cx, double cy, double r, double e)
    ...
    if (params_.ic.type == 1)
    {
        CircularDropletIC ic_func(params_.ic.droplet_center_x,
        ...
        pcout_ << "[Setup] IC: Circular droplet at (" << params_.ic.droplet_center_x
               << "," << params_.ic.droplet_center_y << ") r=" << params_.ic.droplet_radius << "\n";
    }
