...
/**
 * @brief NS assembly with Kelvin force only (legacy, used by MMS tests)
 *
 * Uses H = nabla phi only (no applied field h_a).
 */
template <int dim>
 ...
 *
 * @param params         Simulation parameters (dipoles, reduced field, MMS flags)
