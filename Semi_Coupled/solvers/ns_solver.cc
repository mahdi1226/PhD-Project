...
// FIX (2026-01-17): Pass dt to Block Schur for proper Schur scaling (alpha = nu + 1/dt)
// ============================================================================
...
//
// UPDATED: Now accepts dt parameter for proper Schur complement scaling.
...
//
// UPDATED: Now accepts dt parameter for proper Schur complement scaling.
//          dt > 0: unsteady problem, schur_alpha = nu + 1/dt
