// ============================================================================
// output/parallel_diagnostics_logger.cc - Implementation
// ============================================================================
...
// Constructor
// ============================================================================
ParallelDiagnosticsLogger::ParallelDiagnosticsLogger(
...
// log_step
// ============================================================================
void ParallelDiagnosticsLogger::log_step(const ParallelStepData& d)
{
    step_count_++;
    last_step_ = d.step;
...
// flush
// ============================================================================
void ParallelDiagnosticsLogger::flush()
{
    if (is_root_ && file_.is_open())
        file_.flush();
    if (rank_file_.is_open())
...
// Primary CSV header
// ============================================================================
void ParallelDiagnosticsLogger::write_header(std::ofstream& f)
{
...
// Primary CSV row
// ============================================================================
void ParallelDiagnosticsLogger::write_row(std::ofstream& f,
                                           const ParallelStepData& d)
{
    f << d.step << ","
...
// Per-rank CSV header
// ============================================================================
void ParallelDiagnosticsLogger::write_rank_header(std::ofstream& f)
{
    f << "step,time,rank,"
      << "ch_assemble,ch_solve,"
      << "poisson_assemble,poisson_solve,"
...
// Per-rank CSV row
// ============================================================================
void ParallelDiagnosticsLogger::write_rank_row(std::ofstream& f,
                                                const ParallelStepData& d)
{
    f << d.step << ","
      << std::scientific << std::setprecision(6) << d.time << ","
...
// ============================================================================
// Summary (rank 0, end of simulation)
// ============================================================================
void ParallelDiagnosticsLogger::write_summary()
{
...
// ============================================================================
// get_memory_usage_mb (static)
// ============================================================================
double ParallelDiagnosticsLogger::get_memory_usage_mb()
{
#ifdef __APPLE__
