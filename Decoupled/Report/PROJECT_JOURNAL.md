...
> **HISTORICAL** -- This documents the original monolithic solver (`PhaseField/`).
> The project was refactored into the Decoupled solver architecture in January 2026.
> See `session_handoff.md` in this directory for current status.
...
> **This document is historical.** For the current project state, see:
> - `session_handoff.md` -- Current session handoff and status
> - `SESSION_SUMMARY.md` -- Architecture overview of the Decoupled solver
> - `COUPLING_PLAN.md` -- Coupling strategy details
>
