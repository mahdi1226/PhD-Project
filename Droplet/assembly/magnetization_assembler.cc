...
// ============================================================================
// Susceptibility function: χ(θ, H) with optional Langevin saturation
// Uses susceptibility_langevin() from material_properties.h
// ============================================================================
template <int dim>
double MagnetizationAssembler<dim>::chi(double theta_val, double H_mag) const
{
    return susceptibility_langevin(theta_val, H_mag, params_.use_langevin);
}
    ...
    double dt) const
{
         ...
         ++cell_M, ++cell_U, ++cell_phi, ++cell_theta)
    {
        ...
        for (unsigned int q = 0; q < n_q_cell; ++q)
        {
            ...
            // χ(θ, H) - with optional Langevin saturation
            const double chi_theta = chi(theta_vals[q], H_mag);
