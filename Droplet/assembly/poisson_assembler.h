...
//
// Two modes:
//   1. Uniform field: h_a = H_0 * direction (for Afkhami 2010 validation)
//   2. Dipole field:  h_a = Σ_s α_s ∇φ_s
//
    ...
    double current_time)
{
    ...
    (void)p;  // unused in uniform field mode
    ...
    // ========================================================================
    // Mode 1: Uniform field (for Afkhami 2010 droplet validation)
    // ========================================================================
    if (params.uniform_field.enabled)
    {
        ...
        const double H_0 = params.uniform_field.magnitude * ramp_factor;

        // Direction (should be unit vector)
        h_a[0] = H_0 * params.uniform_field.direction[0];
        h_a[1] = H_0 * params.uniform_field.direction[1];

        return h_a;
    }

    // ========================================================================
    // Mode 2: Dipole field (for Rosensweig/Hedgehog)
    // ========================================================================
